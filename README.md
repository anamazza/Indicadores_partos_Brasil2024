...
Painel interativo dos **543 estabelecimentos de saúde com mais de 1.000 partos em 2024** no Brasil, cobrindo **1.253.881 nascimentos** e os indicadores de qualidade da atenção obstétrica e neonatal.
...
> **Base de dados única:** a planilha institucional `ESTABELECIMENTOS_ACIMA_DE_1000_PARTOS_2024__INDICADORES` (derivada de SINASC, CNES e SIH-SUS; extração de 01/07/2026). Todo número exibido no painel deriva dela e é conferido contra ela pelo script de auditoria (36 verificações, 0 falhas).
...
**Cesárea.** A leitura é pelos **grupos de Robson (G1 a G4)** — cada grupo tem a sua própria meta institucional (ref. Manual de Robson, OMS/OPAS 2017: G1 ≤10% · G2 ≤35% · G3 ≤3% · G4 ≤15%); estabelecimento adequado = **≥2 grupos** dentro da meta. Não há meta de taxa geral de cesariana no painel.
